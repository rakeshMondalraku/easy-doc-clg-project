                    ...
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            <form action="#">
                                ...
                                <div class="mt-10">
                                    <input type="email" name="EMAIL" value="{{$user->email}}" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email address'" required class="single-input">
                                </div>
                                <div class="mt-10">
                                    <input type="text" name="sex" value="{{$user->gender}}" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email address'" required class="single-input">
                                </div>
                                <div class="mt-10">
                                    <input type="text" name="mobile" value="{{$user->mobile}}" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email address'" required class="single-input">
                                </div>
                                <div class="input-group-icon mt-10">
                                    <div class="icon"><i class="fa fa-thumb-tack" aria-hidden="true"></i>
                                    </div>
                                    <input type="text" name="address" placeholder="Address" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Address'" required class="single-input" value="{{$user->address}}">
                                </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="row align-items-center my-3">
                                            <div class="col">
                                                <button type="button" class="btn mb-2 btn-warning disabled" data-dismiss="modal">Pending</button>
                                            </div>
                                            <div class="col-auto">
